...
public class MetadataJobReducer extends Reducer<Text, Text, Text, DatasetMetainfo> {

    @Override
    protected void reduce(Text key, Iterable<Text> values, Reducer<Text, Text, Text, DatasetMetainfo>.Context context) throws IOException, InterruptedException {
